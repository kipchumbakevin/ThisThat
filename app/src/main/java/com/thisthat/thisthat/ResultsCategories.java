...
//                        .build());
    ...
    private void inflateAd(NativeAd nativeAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(ResultsCategories.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(ResultsCategories.this, nativeAd, nativeAdLayout);
