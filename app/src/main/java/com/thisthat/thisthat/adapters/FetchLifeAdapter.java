...
public class FetchLifeAdapter extends RecyclerView.Adapter<FetchLifeAdapter.FetchViewHolder> {
    private final Context mContext;
    private final ArrayList<FetchAllModel> mArrayList;
    private final LayoutInflater mLayoutInflator;

    public FetchLifeAdapter(Context context, ArrayList<FetchAllModel> arrayList){
        mContext = context;
