...
public class FriendPartnerAdapter extends RecyclerView.Adapter<FriendPartnerAdapter.FetchViewHolder> {
    private final Context mContext;
    private final ArrayList<FetchAllModel> mArrayList;
    private final LayoutInflater mLayoutInflator;

    public FriendPartnerAdapter(Context context, ArrayList<FetchAllModel> arrayList){
        mContext = context;
    ...
    @NonNull
    @Override
    public FriendPartnerAdapter.FetchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mLayoutInflator.inflate(R.layout.would,parent,false);
        return new FetchViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FriendPartnerAdapter.FetchViewHolder holder, int position) {
        FetchAllModel fetchAllModel = mArrayList.get(position);
        holder.title.setText("Partner type: "+fetchAllModel.getId());
