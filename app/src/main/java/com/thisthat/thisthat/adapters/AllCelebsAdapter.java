...
import com.thisthat.thisthat.AllCelebsActivity;
...
public class AllCelebsAdapter extends RecyclerView.Adapter<AllCelebsAdapter.AllCelebViewHolder> {
    private final Context mContext;
    private final ArrayList<AllCelebsModel> mArrayList;
    private final LayoutInflater mLayoutInflator;

    public AllCelebsAdapter(Context context, ArrayList<AllCelebsModel>arrayList){
        mContext = context;
    ...
    @NonNull
    @Override
    public AllCelebViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mLayoutInflator.inflate(R.layout.would,parent,false);
        return new AllCelebViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllCelebViewHolder holder, int position) {
