...
public class FetchPartnerAdapter extends RecyclerView.Adapter<FetchPartnerAdapter.FetchViewHolder> {
    private final Context mContext;
    private final ArrayList<FetchAllModel> mArrayList;
    private final LayoutInflater mLayoutInflator;

    public FetchPartnerAdapter(Context context, ArrayList<FetchAllModel> arrayList){
        mContext = context;
    ...
    @NonNull
    @Override
    public FetchPartnerAdapter.FetchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mLayoutInflator.inflate(R.layout.would,parent,false);
        return new FetchViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FetchPartnerAdapter.FetchViewHolder holder, int position) {
