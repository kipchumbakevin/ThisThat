...
import com.thisthat.thisthat.EvaluatedMeThem;
...
public class EvaluatedMeThemAdapter extends RecyclerView.Adapter<EvaluatedMeThemAdapter.ViewHolder> {
    private final Context mContext;
    private final ArrayList<FetchContactListModel> mArrayList;
    private final LayoutInflater mLayoutInflator;

    public EvaluatedMeThemAdapter(Context context, ArrayList<FetchContactListModel> arrayList) {
        mContext = context;
