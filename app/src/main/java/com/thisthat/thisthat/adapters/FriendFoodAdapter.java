...
public class FriendFoodAdapter extends RecyclerView.Adapter<FriendFoodAdapter.FetchViewHolder> {
    private final Context mContext;
    private final ArrayList<FetchAllModel> mArrayList;
    private final LayoutInflater mLayoutInflator;

    public FriendFoodAdapter(Context context, ArrayList<FetchAllModel> arrayList){
        mContext = context;
    ...
    @NonNull
    @Override
    public FriendFoodAdapter.FetchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mLayoutInflator.inflate(R.layout.would,parent,false);
        return new FetchViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FriendFoodAdapter.FetchViewHolder holder, int position) {
        FetchAllModel fetchAllModel = mArrayList.get(position);
        holder.title.setText("Food/Beverage: "+fetchAllModel.getId());
