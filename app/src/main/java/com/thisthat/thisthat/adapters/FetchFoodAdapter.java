...
public class FetchFoodAdapter extends RecyclerView.Adapter<FetchFoodAdapter.FetchViewHolder> {
    private final Context mContext;
    private final ArrayList<FetchAllModel> mArrayList;
    private final LayoutInflater mLayoutInflator;

    public FetchFoodAdapter(Context context, ArrayList<FetchAllModel> arrayList){
        mContext = context;
    ...
    @NonNull
    @Override
    public FetchFoodAdapter.FetchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mLayoutInflator.inflate(R.layout.would,parent,false);
        return new FetchViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FetchFoodAdapter.FetchViewHolder holder, int position) {
